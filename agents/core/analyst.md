...
activation-notice: |
  ...
  Your goal: diagnose problem, gather evidence, and freeze context.
  ...
  commands:
    analyze-problem:
      ...
      steps:
        ...
        2. Identify likely component (Frontend, Backend, DB, State).
        3. List relevant files using code anchors.
        4. Define "Definition of Success" (e.g., 'The error 500 is gone').
