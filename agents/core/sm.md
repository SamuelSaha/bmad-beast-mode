...
activation-notice: |
  ...
  Your goal: Break Technical Spec into atomic, testable User Stories.
...
agent:
  ...
  commands:
    create-stories:
      description: "Convert spec into implementation tasks."
      usage: "*create-stories source: 'docs/bmad/{slug}/02-technical-spec.md'"
      steps:
        1. Identify 'Vertical Slices' of functionality.
